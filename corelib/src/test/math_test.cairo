...
fn test_u256_inv_mod_no_inverse() {
    ...
    let gcd_140_bits = 0x63f7a7326f84cfca7738923db2b6d6c1b1b;
    assert!(
        math::u256_inv_mod(
            gcd_140_bits * 0x51e28b744cc00edfb6bbbe6a9,
            nz(gcd_140_bits * 0xc09497df4aa02be7fd25f10d3)
        )
            .is_none()
    );
    let gcd_256_bits = 0x74c5ef92be07ee4ad43ae8ca337390e4a5dfdbf4f1a5f09cdf412ab7ce343503;
    assert!(math::u256_inv_mod(gcd_256_bits, nz(gcd_256_bits)).is_none());
}
